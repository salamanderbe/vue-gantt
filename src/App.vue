<template>
    <div id="app">
        <gantt :title="title" :fields="fields" :items="items"  />
    </div>
</template>
	...
	data() {
		return {
			...
			items: [
				...
				{ id: 3, user: { id: 1, src: './default-1.png' }, summary: 'You should first complete the first task.', start_date: '2018-11-04 00:00', end_date: '2018-11-11 00:00', duration: 8, progress: 10 },
				{ id: 4, user: { id: 2, src: './default-2.png' }, summary: 'And then, you should complete the second task.', start_date: '2018-11-07 00:00', end_date: '2018-11-09 00:00', duration: 3, progress: 0 },
				...
				{ id: 8, user: { id: 1, src: './default-1.png' }, summary: 'Do not make your project manager mad.', start_date: '2018-11-19 00:00', end_date: '2018-11-21 00:00', duration: 3, progress: 0 }
			]
		}
	}
}
